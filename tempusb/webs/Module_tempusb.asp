...
<body>
                                        ...
                                        <td bgcolor="#4D595D" colspan="3" valign="top">
                                            ...
                                            <table style="margin: 20px 0px 0px 0px;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
                                                ...
                                                <tr id="sk_tr">
                                                    <th>温度下限（USB关闭）</th>
                                                    <td>
                                                        <input type="text" id="tempusb_down" value="<% dbus_get_def("tempusb_down", "60"); %>" class="input_ss_table"></td>
                                                </tr>
                                                <tr id="interval_tr">
                                                    <th>检查周期</th>
                                                    <td>
                                                        <input type="text" style="width: 2.5em" id="tempusb_interval" value="<% dbus_get_def("tempusb_interval", "120"); %>" class="input_ss_table">s</td>
                                                </tr>
                                            </table>
                                            <div class="apply_gen">
                                            ...
                                            <div class="KoolshareBottom" style="margin-top: 540px;">
                                                ...
                                                <br />
                                                Github项目： <a href="https://github.com/koolshare/koolshare.github.io/tree/acelan_softcenter_ui" target="_blank"><i><u>github.com/koolshare</u></i> </a>
                                                <br />
    ...
    <script type='text/javascript'>
        ...
        var up_temp = $("#tempusb_up").val();
        var down_temp = $("#tempusb_down").val();
        ...
        function update_visibility() {
            if (document.getElementById('switch').checked) {
                ...
                document.getElementById("temperature_tr").style.display = "";
            } else {
                ...
                document.getElementById("temperature_tr").style.display = "none";
            }
        }
